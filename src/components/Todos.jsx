  ...
  return (
    <>
      <ul className="list-none space-y-4">
        {todos.map((todo) => (
          <li
            className="flex justify-between items-center bg-zinc-800 px-4 py-2 rounded hover:bg-zinc-700 transition-colors duration-300 border-sky-200 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f]"
            key={todo.id}
          >
            {editingId === todo.id ? (
